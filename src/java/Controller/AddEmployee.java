...
/**
 * Interaction logic for AddEmployee.
 */
public class AddEmployee extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        if (request.getParameter("AddEmployeeAddButton") != null)
        {
            // Create the Employee to add.
            Model.Employee employee = new Model.Employee();
            employee.setEmployeeId(businessLogicLayer.ListEmployees().getItems().size() + 1);
            ...
            {
                RequestDispatcher redirect = request.getRequestDispatcher("/WEB-INF/AddEmployee.jsp");
