...
/**
 * Interaction logic for DeleteEmployee.
 */
public class DeleteEmployee extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        {
            if (oneItem.getRelationEmployee() == Integer.parseInt(request.getParameter("id")) && relation.getRelationId() < 1)
            {
                relation = oneItem;
            }
        }
        ...
        if (request.getParameter("DeleteEmployeeDeleteButton") != null)
        {
            ...
            {
                RequestDispatcher redirect = request.getRequestDispatcher("/WEB-INF/DeleteEmployee.jsp");
